const id = {
  ...
  budgetDisabledHint: "Kolom ini dihitung otomatis dari mata uang lainnya.",
  ...
  couldNotLoad: "Gagal memuat perjalanan.",
  previewTitle: "Pratinjau",
  previewHint: "Pilih 'Simpan sebagai PDF' di dialog cetak.",
