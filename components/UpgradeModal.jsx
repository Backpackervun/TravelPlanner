    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 py-6">
      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-paper-line bg-white p-8 shadow-card animate-fade-in">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-ink">{t("upgradeTitle") || "Unlock the Planner"}</h2>
          <p className="mt-2 text-sm text-ink-muted leading-relaxed">
            {reason ?? t("upgradeSubtitle") ?? "Enter a redeem code or upgrade your plan to start creating itineraries."}
          </p>
        </div>
        ...
        <div className="space-y-2.5">
          ...
          >
            🎟️ {t("redeemCode") || "Enter Redeem Code"}
          </button>
          ...
          >
            ...
            {t("contactBackpackervun") || "Contact Backpackervun"}
          </a>
        </div>
      </div>
    </div>
