...
/*
 * PrintLayout — FINAL STABLE VERSION
 */
...
function formatTime(str) {
  ...
  return `${h12}:${String(m || 0).padStart(
    2,
    "0"
  )} ${ampm}`;
}
    ...
    <div className="itinerary-pdf font-sans text-ink bg-white">
      ...
      <div className="px-8 pt-6 pb-4">
        ...
        <div className="rounded-xl border border-[#E8EDF3] bg-[#F8FAFC] p-5">
          ...
          {tripInfo?.clientName && (
            <div className="mb-4">
              <p className="text-[9px] font-semibold uppercase tracking-[0.2em] text-ink-muted">
          ...
          <div className="space-y-5">
            ...
            {byDay.map(([dateKey, dayRows]) => {
              ...
              return (
                <div
                  key={dateKey}
                  className="day-block rounded-xl overflow-hidden border border-[#E8EDF3]"
                >
...
function PrintRow({
  ...
  const mapUrl =
    `https://www.google.com/maps/search/?api=1&query=${destQ}`;
    ...
    <div className="px-5 py-4">
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-shrink-0 w-14 text-right">
          ...
          {row.time ? (
            <p className="text-xs font-semibold text-ink-muted font-mono">
              {formatTime(row.time)}
            </p>
          ) : (
            <p className="text-xs text-ink-muted/30">
              —
            </p>
          )}
