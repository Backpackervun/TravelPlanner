...
<button
  type="button"
  onClick={onLogout}
  className="no-print inline-flex items-center gap-1.5 rounded-lg border border-red-200 bg-white px-3 py-2 text-xs font-medium text-red-500 shadow-soft transition hover:bg-red-50"
>
  Logout
</button>
