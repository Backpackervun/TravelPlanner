    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-paper-line bg-white p-8 shadow-card animate-fade-in">
        ...
        <div className="mt-5 grid grid-cols-3 gap-2 text-center">
          {[
            { name: t("free"), desc: t("planFreeDesc") || "Trial 7 days",          badge: "bg-gray-100 text-gray-500" },
            { name: t("lite"), desc: t("planLiteDesc") || "3 trips · 25 rows",      badge: "bg-blue-100 text-blue-700" },
            { name: t("pro"),  desc: t("planProDesc")  || "Unlimited",               badge: "bg-violet-100 text-violet-700" },
          ].map((p) => (
