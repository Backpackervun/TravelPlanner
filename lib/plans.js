...
export function getPlanFeatures(plan) {
  ...
  return {
    ...
    // Row & trip limits
    // FREE: unlimited (but 7-day expiry window)
    // LITE: max 3 saved trips, max 25 rows per trip
    // PRO:  unlimited
    maxRows:  isPro ? Infinity : isLite ? 25 : Infinity,
...
export const UPGRADE_REASONS = {
  ...
  maxRows:          "LITE plan is limited to 25 rows per trip. Upgrade to Pro for unlimited rows.",
  maxTrips:         "LITE plan is limited to 3 saved trips. Upgrade to Pro for unlimited trips.",
};

export const PLAN_LIMITS = {
  FREE: { maxItineraries: Infinity, maxRows: Infinity, pdfExport: false, save: true  },
